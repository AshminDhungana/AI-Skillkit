...
npx  install /project-management

# Install to Claude Code only
npx  install /project-management --agent claude

# Install to Cursor only
npx  install /project-management --agent cursor
```
...
npx  install /project-management/senior-pm

# Scrum Master Expert
npx  install /project-management/scrum-master

# Atlassian Jira Expert
npx  install /project-management/jira-expert

# Atlassian Confluence Expert
npx  install /project-management/confluence-expert

# Atlassian Administrator
npx  install /project-management/atlassian-admin

# Atlassian Template Creator
npx  install /project-management/atlassian-templates
```
