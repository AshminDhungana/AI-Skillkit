...
This plugin is ported from David Dworken's MIT-licensed implementation in [`/aeo-box`](https://github.com//aeo-box/tree/main/.claude/plugins/security-guidance).
...
**Version:** 2.7.3
**Source:** Ported from [`/aeo-box`](https://github.com//aeo-box) `.claude/plugins/security-guidance/` (originally by David Dworken at Anthropic, MIT)
**License:** MIT
