...
npx  install /ra-qm-team

# Install to Claude Code only
npx  install /ra-qm-team --agent claude

# Install to Cursor only
npx  install /ra-qm-team --agent cursor
```
...
npx  install /ra-qm-team/regulatory-affairs-head
npx  install /ra-qm-team/quality-manager-qmr

# Quality Systems
npx  install /ra-qm-team/quality-manager-qms-iso13485
npx  install /ra-qm-team/capa-officer
npx  install /ra-qm-team/quality-documentation-manager

# Risk & Security
npx  install /ra-qm-team/risk-management-specialist
npx  install /ra-qm-team/information-security-manager-iso27001

# Regulatory Specialists
npx  install /ra-qm-team/mdr-745-specialist
npx  install /ra-qm-team/fda-consultant-specialist

# Audit & Compliance
npx  install /ra-qm-team/qms-audit-expert
npx  install /ra-qm-team/isms-audit-expert
npx  install /ra-qm-team/gdpr-dsgvo-expert
```
