...
npx  install /c-level-advisor

# Install to Claude Code only
npx  install /c-level-advisor --agent claude

# Install to Cursor only
npx  install /c-level-advisor --agent cursor
```
...
```bash
# CEO Advisor
npx  install /c-level-advisor/ceo-advisor

# CTO Advisor
npx  install /c-level-advisor/cto-advisor
```
