...
npx  install /marketing-skill

# Install to Claude Code only
npx  install /marketing-skill --agent claude

# Install to Cursor only
npx  install /marketing-skill --agent cursor
```
...
```bash
# Content Creator
npx  install /marketing-skill/content-creator

# Demand Generation & Acquisition
npx  install /marketing-skill/marketing-demand-acquisition

# Product Marketing Strategy
npx  install /marketing-skill/marketing-strategy-pmm

# App Store Optimization
npx  install /marketing-skill/app-store-optimization

# Social Media Analyzer
npx  install /marketing-skill/social-media-analyzer

# Campaign Analytics
npx  install /marketing-skill/campaign-analytics
```
